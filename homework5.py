...
# Кортежи - это неизменяемый тип данных в Python, также как строки и числа.
# Кортежи являются последовательностью как и списки, но после создания их изменить невозможно.
